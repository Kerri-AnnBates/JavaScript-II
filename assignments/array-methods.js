...
let ticketPriceTotal = runners.reduce((ticketPriceTotal, currVal) => {
...
// Problem 1
  //We can add a new property to each runner to determine whether it's their first time doing the event or not
runners.forEach((runner) => {
  runner.isNew = true;
});
